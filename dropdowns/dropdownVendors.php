...
<ul>
	<li>
		<img src="images/logo4.png" height="100px" style="margin-left:40px"/>
	</li>

	<li>
		<a href="index.php" style="margin-left:50px;margin-top:30px">Home</a>
	</li>
	...
	<li>
		<a href="dark_events.php" style="margin-top:30px">Events</a>
	</li>
	<li>
		<a href="aboutUs.php" style="margin-top:30px">About Us</a>
	</li>
	<?php if(empty($_SESSION['user_email']) && empty($_SESSION['vendor_email'])
		&& empty($_SESSION['admin_email'])){ ?>
	<li style="float:right;margin-top:30px"><a href="user/user_login.php">Login</a>	</li>			
	<?php }else if(!empty($_SESSION['user_email'])) { ?>
	<li style="float:right;margin-top:30px"><a href="user/logout.php">Logout</a> </li>					
	<?php }else if(!empty($_SESSION['vendor_email'])) { ?>
	<li style="float:right;margin-top:30px;"><a href="vendors/logout.php">Logout</a></li>			
	<?php }else if(!empty($_SESSION['admin_email'])) { ?>
	<li style="float:right;margin-top:30px;"><a href="admin/logout.php">Logout</a></li>				
	<?php } ?>
