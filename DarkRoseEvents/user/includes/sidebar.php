<div id="wrapper">
    ...
    <ul class="sidebar navbar-nav" style="background-color:#333;">
      ...
      <li class="nav-item">
        <a class="nav-link" href="imgs/<?php echo $row['picture']; ?>" target="_blank">
        	<img src="imgs/<?php echo $row['picture']; ?>" width="140px" height="150px" 
            	border='2px'  
      ...
      <li class="nav-item">
        <a class="nav-link" href="../Deals.php">
          <i class="fas fa-fw fa-image"></i>
          <span style="color:#fff;">Deals</span></a>
      </li> 
      
       <li class="nav-item">
        <a class="nav-link" href="../vendors.php">
          <i class="fas fa-fw fa-image"></i>
          <span style="color:#fff;">Vendors</span></a>
      </li> 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="del_account.php?delid=<?php echo $row['user_id'];?>" style="background-color:#C03;">Delete</a>
        </div>
      </div>
    </div>
  </div>