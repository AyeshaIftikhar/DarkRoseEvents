...
<footer>
    ...
    <div class="divLinks">
     ...
     <div class="divCategories">
		...
		<a href="venue.php">Venues</a><br><br>
        <a href="photographer.php">Photographers</a> <br><br>
        <a href="decorator.php">Decorators</a><br><br>
        <a href="invitation.php">Invitations</a><br><br>
        <a href="car_rent.php">Car Rental</a> <br><br>
     ...
     <div class="divJlinks" >
        ...
        <a href="vendor_login.php">Vendor Login</a><br><br>
        <a href="register.php">Vendor Signup</a> <br><br>
	...
	<?php }else{ ?>
        ...
        <a href="#" disabled>Admin Login</a> 
    <?php }?>
    </div>
    
    <div class="divSLink">
    	<h3 style="margin-right:50px;">Follow Us:</h3>        	
            <!links>
