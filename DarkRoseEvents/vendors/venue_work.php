...
<div class="card card-register mx-auto mt-5">
      ...
      <div class="text-center">Add your work demo here all the fields should b filled and add three pictures alteasts !</div>
       <div class="text-center"><strong>Note:</strong>  Only .jpg, .jpeg and .png files are acceptable!
        ...
        <div class="text-center"> Address should be in Proper address format!
       </div>
      <div class="card-body">
      		<?php
			...
			if(isset($_POST['register'])){
				...
				$email=$row['Email']; $place_name=$_REQUEST['place_name']; 
				...
				$query="INSERT INTO venues_demo
					(vendor_name,vendor_email,place_name,venue_address,
					front_image,image_two,image_three,image_four
					,image_five,image_six)
					values('$vname','$email','$place_name','$address',
        ...
        <form action="#" method="POST" id="Add_work" name="Work Demo" enctype="multipart/form-data">
          <div class="form-group">
                <div class="form-label-group">
                  <input type="text" id="styleName" name="place_name" class="form-control" placeholder="Place Name" required autofocus>
                  <label for="styleName">Place Name</label>
           </div>
          </div>
          
           <div class="form-group">
                <div class="form-label-group">
                  <input type="text" id="address" name="address" class="form-control" placeholder="Venue Address" required >
