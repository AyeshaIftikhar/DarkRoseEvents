...
<nav class="navbar navbar-expand navbar-dark bg-dark static-top" >
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      <li class="nav-item dropdown no-arrow">
        ...
        <i>
        <img src="imgs/<?php echo $row['vendor_pic'];?>" width="30px" height="35px" 
         />
        </i>
        </a>
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          <a class="dropdown-item" href="view_info.php"
          	onMouseover="this.style.color='#C03'" onMouseOut="this.style.color='#333'"
            onmousemove="this.style.color='#C03'"
          >View Information</a>
          <a class="dropdown-item" href="edit_info.php"
          	onMouseover="this.style.color='#C03'" onMouseOut="this.style.color='#333'"
            onmousemove="this.style.color='#C03'"
          >Edit Information</a>
          <a class="dropdown-item" href="change_password.php"
            ...
            onmousemove="this.style.color='#C03'"
          >Change Password</a>
          <div class="dropdown-divider" style="background-color:#C03;"></div>
          <h6 class="dropdown-header" style="color:#C02;">Other Pages:</h6> 
          <a class="dropdown-item" href="forget_password.php"
          	onMouseover="this.style.color='#C03'" onMouseOut="this.style.color='#333'"
            onmousemove="this.style.color='#C03'"
          >Forget Password</a>
