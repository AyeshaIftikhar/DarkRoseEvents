<!DOCTYPE html>
<html lang="en">
<?php include '/xampp/htdocs/project/connection.php'; ?>
<head>
  <meta charset="utf-8">
      		...
      		<?php 
				...
				if(isset($_POST['reset'])){
					...
					if($count==1){
						...
						$from="ayeshaiftikhar189@gmail.com";
						...
						else{echo "Failed! to recover your passowrd try again later.";}
					}
					else{echo "Email does not exists in database.";}
				}
